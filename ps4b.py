...
def playGame(wordList,hand=None):
    ...
    point1 = input('Enter n to deal a new hand, r to replay the last hand, or e to end game:')
	n = HAND_SIZE
	...
	if point1 == 'e':
		...
		hand = dealHand(n)
		point2 = input('Enter u to have yourself play, c to have the computer play:')
		if point2 == 'u':
